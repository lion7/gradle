...
fun BuildSteps.substDirOnWindows(os: Os) {
    if (os == Os.WINDOWS) {
        ...
        cleanBuildLogicBuild("P:/build-logic/build-logic-base")
        cleanBuildLogicBuild("P:/build-logic/build-logic-commons")
        cleanBuildLogicBuild("P:/build-logic/build-logic")
    }
}
...
fun BuildSteps.removeSubstDirOnWindows(os: Os) {
    if (os == Os.WINDOWS) {
        ...
        cleanBuildLogicBuild("%teamcity.build.checkoutDir%/build-logic/build-logic-base")
        cleanBuildLogicBuild("%teamcity.build.checkoutDir%/build-logic/build-logic-commons")
        cleanBuildLogicBuild("%teamcity.build.checkoutDir%/build-logic/build-logic")
    }
}
