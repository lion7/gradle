...
class DependencyGraphBuilderTest extends Specification {
    ...
    def rootProject(String name, String revision = '1.0', List<String> extraConfigs = []) {
        def metaData = new RootLocalComponentMetadata(newId("group", name, revision), newProjectId(":${name}"), "release", attributesSchema, new NoOpDependencyLockingProvider(null))
